    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.Option', verbose_name='Опция')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_price', models.FloatField(default=0, verbose_name='Стоимость доставки')),
                ...
                ('shipping_type_name', models.CharField(blank=True, default='', max_length=50, verbose_name='Способ доставки')),
