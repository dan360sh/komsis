...
from .compatibility import dates
...
logger = logging.getLogger('chronographv2.models')
...
class Job(models.Model):
    ...
    def handle_run(self):
        ...
        PATH_LOG = '/var/tmp/LOG_ANT.txt'
        PATH_LOG_ERR = '/var/tmp/LOG_ERR_ANT.txt'
        ...
        try:
            ...
            t = loader.get_template('chronographv2/error_message.txt')
            c = Context({
              'exception': unicode(e),
        ...
        file_log.close()
        file_err.close()
        stdout_str = open(PATH_LOG, 'r').read()
        stderr_str = open(PATH_LOG_ERR, 'r').read()
