(function() {
        ...
        CustomInlines.prototype = {
            add(event) {
                ...
                deleteBtn.onclick = function(event) {
                    ...
                    var forms = document.querySelectorAll(".inline-item-" + _this.options.prefix)
                    ...
                    forms.forEach(function(item, index) {
                        ...
                        $(item).find('*').each(function(ind, element) {
                            _this.updateElementIndex(element, _this.options.prefix, ind)
                        })
                    })
    ...
    Array.prototype.slice.call(container.children).forEach(function(item) {
        var btn = item.querySelector('.inline-item-roll-up')
        var body = item.querySelector('.inline-item-body')
